...
<template>
    <GuestLayout>
        ...
        <!-- Left section -->
        <div
            class="hidden min-h-screen w-full bg-primary-600 md:w-1/2 md:flex md:items-center md:justify-center"
        >
            <div class="max-w-lg">
                <img
                    src="/svg/login_illustration.svg"
        ...
        <!-- Rigth section -->
        <div
            class="relative flex items-center justify-center min-h-screen w-full md:w-1/2 overflow-hidden"
        >
            <div class="max-w-lg">
                <!-- wave -->
                <div
                    class="hidden absolute -z-10 left-0 top-0 bottom-0 aspect-[3/16] md:block"
                >
                    <svg
                        viewBox="0 0 192 1080"
                        fill="none"
