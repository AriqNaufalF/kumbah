...
<template>
    <GuestLayout>
        ...
        <Head title="Log in" />
        <!-- Left section -->
        <div class="hidden min-h-screen w-full bg-primary-600 md:w-1/2 md:flex md:items-center md:justify-center">
            <div class="max-w-lg">
        ...
        <div class="relative flex items-center justify-center min-h-screen w-full md:w-1/2 overflow-hidden">
            <div class="max-w-lg">
                <!-- wave -->
                <div class="hidden absolute -z-10 left-0 top-0 bottom-0 aspect-[3/16] md:block">
                ...
                <form @submit.prevent="submit">
                    <div>
                        ...
                        <TextInput id="email" type="text" v-model="form.email" required autofocus
                            autocomplete="email" />
                    </div>
                    <div class="mt-3">
