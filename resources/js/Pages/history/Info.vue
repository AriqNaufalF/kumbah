        ...
        <div class="py-10 px-6 mx-auto">
            ...
            <div class="mt-10 mx-auto max-w-7xl">
                <div class="p-6 bg-white shadow-lg rounded-lg">
                    <h3 class="font-semibold text-lg">Order ID 1</h3>
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            <InputLabel for="start" value="Order Date" class="mb-2" />
                            <TextInput id="start" type="text" class="w-full" readonly />
                        </div>
                        <div>
                            <InputLabel for="end" value="Finished date" class="mb-2" />
                            <TextInput id="end" type="text" class="w-full" readonly />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <div>
                                ...
                                <TextInput id="memberId" type="text" class="w-full" readonly />
                            </div>
                            <!-- Input name -->
                            <div class="mt-3">
                                <InputLabel for="name" value="Name" class="mb-2" />
                                <TextInput id="name" type="text" class="w-full" readonly />
                            </div>
                            <!-- Input service -->
                            <div class="mt-3">
                                <div class="flex gap-3">
                                    <div class="w-full">
                                        ...
                                        <TextInput id="service" type="text" class="w-full" readonly />

                                    </div>
                                    <div class="ml-auto">
                                        <InputLabel for="serviceQty" value="Quantity" class="mb-2" />
                                        <TextInput id="serviceQty" type="number" class="max-w-[120px] w-full" min="1"
                                            readonly />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="h-full flex flex-col">
                            ...
                            <div>
                                ...
                                <TextInput id="subTotal" type="text" class="w-full text-right" readonly />
                            </div>
                            <!-- Input discount -->
                            <div class="mt-3">
                                <InputLabel for="discount" value="Additional Discount" class="mb-2" />
                                <TextInput id="discount" type="text" class="w-full text-right" readonly />
                            </div>
                            <!-- Input total price -->
                            <div class="mt-3">
                                <InputLabel for="totalPrice" value="Total Price" class="mb-2" />
                                <TextInput id="totalPrice" type="text" class="w-full text-right" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col mt-3">
                        <h3 class="font-semibold text-lg">Order Detail</h3>
                        <div class="grid grid-cols-2 gap-6 mb-3" v-for="(item, index) in clothes" :key="index">
                            <div>
